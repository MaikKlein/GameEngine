...
IF (MINGW)
    ...
    FIND_LIBRARY( GLFW3_LIBRARY
        NAMES glfw3dll
        PATHS
        ${DEPENDENCIES_PATH}/glfw/lib-mingw
    )

    execute_process(COMMAND ${CMAKE_COMMAND}  -E  copy_if_different
        ${DEPENDENCIES_PATH}/glfw/lib-mingw/glfw3.dll
...
ELSEIF (MSVC)
    ...
    FIND_LIBRARY( GLFW3_LIBRARY
        NAMES glfw3dll
        PATHS
        ${DEPENDENCIES_PATH}/glfw/lib-msvc110
    )

    foreach (CONFIGURATION_TYPE ${CMAKE_CONFIGURATION_TYPES})
        execute_process(COMMAND ${CMAKE_COMMAND}  -E  copy_if_different
            ${DEPENDENCIES_PATH}/glfw/lib-msvc110/glfw3.dll
